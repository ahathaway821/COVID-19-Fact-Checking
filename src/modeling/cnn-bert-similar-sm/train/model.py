...
def download_weights(local_weights_file):
    ...
    data_key = 'CNN_BERT_SIMILAR_TRAINABLE_V2_weights-improvement-06-0.98.hdf5' #'BERT_EMBEDDINGS_TRAINABLE_CNN_weights-improvement-19-0.98.hdf5'
...
def save_tokenizer_pickle(tokenizer):
    # save locally
    with open('bert_tokenizer_similar.pickle', 'wb') as f:
        pickle.dump(tokenizer, f)
    
    # save to s3 for reference
    bucket='covid-19-claims'
    key='bert_tokenizer_similar.pickle'
